        ...
        <section className="border-t border-edge py-16 lg:py-20">
          ...
          <figure className="border border-edge bg-panel">
            ...
            <Image
              ...
              alt="Live control room: a zone-agent network negotiating overflow peer-to-peer and executing signage reroutes on simulated telemetry"
              width={1440}
              height={1148}
              priority
            ...
            <figcaption className="max-w-[69ch] border-t border-edge px-3 py-2 text-[11px] leading-relaxed text-term-dim">
              ...
              is the running system on simulated input.
            </figcaption>
          </figure>
        </section>
          ...
          <div className="mt-8 grid gap-6 lg:grid-cols-2">
            <div className="border border-edge bg-panel">
              ...
              <div className="max-w-[65ch] px-4 py-4 text-[11px] leading-relaxed text-[#c7d2cf]">
                ...
                <span className="text-slate-100">vision seam · simulated input</span> (synthetic
                CCTV through the density model).
              </div>
            </div>
            <div className="border border-edge bg-panel">
              <div className="flex items-center gap-2 border-b border-edge px-4 py-2 text-[10px] tracking-widest">
              ...
              <div className="max-w-[65ch] px-4 py-4 text-[11px] leading-relaxed text-[#c7d2cf]">
                Live HF inference on real CCTV: the density seam&apos;s live path is stubbed; the
                simulator drives the demo until it lands. No real venue footage is implied.
              </div>
            </div>
          </div>
