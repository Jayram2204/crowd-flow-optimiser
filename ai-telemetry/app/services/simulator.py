"""Synthetic CCTV pipeline: turns the venue scenario + vision seam into
backend telemetry. In production this process consumes real camera frames;
here it manufactures them so the whole stack runs with zero hardware.
"""
import asyncio
import logging
